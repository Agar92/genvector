...
public:
  ...
  */
  template <class IT> Quaternion(IT begin, IT end)
  {
  ...
  */
  template <class OtherRotation> explicit Quaternion(const OtherRotation &r);
  ...
  */
  template <class OtherRotation> Quaternion &operator=(OtherRotation const &r);
  ...
  */
  template <class R> Quaternion &operator*=(const R &r)
  {
    return *this = (*this) * r;
  }
...
/**
   Rotation operation on a cartesian vector
*/
inline Quaternion::XYZVector Quaternion::operator()(const XYZVector &v) const
{
...
*/
template <class CoordSystem, class Tag>
DisplacementVector3D<CoordSystem, Tag> Quaternion::
operator()(const DisplacementVector3D<CoordSystem, Tag> &v) const
{
...
*/
template <class CoordSystem, class Tag>
PositionVector3D<CoordSystem, Tag> Quaternion::
operator()(const PositionVector3D<CoordSystem, Tag> &p) const
{
...
*/
template <class CoordSystem>
LorentzVector<CoordSystem> Quaternion::
operator()(const LorentzVector<CoordSystem> &v) const
{
...
*/
template <class ForeignVector>
ForeignVector Quaternion::operator()(const ForeignVector &v) const
{
...
Quaternion &Quaternion::operator=(OtherRotation const &r)
{
...
template <class OtherRotation>
inline Quaternion::Quaternion(const OtherRotation &r)
{
  gv_detail::convert(r, *this);
}
...
inline void Quaternion::Rectify()
{
  ...
  Scalar a = 1.0 / sqrt(fU * fU + fI * fI + fJ * fJ + fK * fK);
  fU *= a;
  fI *= a;
  fJ *= a;
  fK *= a;
...
// Quaternion::operator() (const DisplacementVector3D< Cartesian3D<double> > &
// v) const
// {
...
//    return Quaternion                          (
//                                                fU*q.fU - fI*q.fI - fJ*q.fJ -
//                                                fK*q.fK , fU*q.fI + fI*q.fU +
//                                                fJ*q.fK - fK*q.fJ , fU*q.fJ -
//                                                fI*q.fK + fJ*q.fU + fK*q.fI ,
//                                                fU*q.fK + fI*q.fJ - fJ*q.fI +
//                                                fK*q.fU  );
//}

inline Quaternion Quaternion::operator*(const Rotation3D &r) const
{
  // combination of rotations
  return operator*(Quaternion(r));
}

inline Quaternion Quaternion::operator*(const AxisAngle &a) const
{
  // combination of rotations
  return operator*(Quaternion(a));
}

inline Quaternion Quaternion::operator*(const EulerAngles &e) const
{
  // combination of rotations
  return operator*(Quaternion(e));
}

inline Quaternion Quaternion::operator*(const RotationZYX &r) const
{
  // combination of rotations
  return operator*(Quaternion(r));
}

inline Quaternion::Scalar Quaternion::Distance(const Quaternion &q) const
{
  // distance
