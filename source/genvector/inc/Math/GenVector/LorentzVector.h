...
public:
  ...
  */
  constexpr LorentzVector() : fCoordinates() {}
  ...
  */
  constexpr LorentzVector(const Scalar &a, const Scalar &b, const Scalar &c,
                          const Scalar &d)
  ...
  */
  ...
  constexpr explicit LorentzVector(const LorentzVector<Coords> &v)
  ...
  */
  ...
  constexpr explicit LorentzVector(const ForeignLorentzVector &v)
  ...
  */
  ...
  {
    fCoordinates =
        CoordSystem(v[index0], v[index0 + 1], v[index0 + 2], v[index0 + 3]);
  }
#endif
  ...
  */
  ...
  constexpr LorentzVector &operator=(const LorentzVector<OtherCoords> &v)
  {
    fCoordinates = v.Coordinates();
    return *this;
  }
  ...
  */
  template <class ForeignLorentzVector>
  constexpr LorentzVector &operator=(const ForeignLorentzVector &v)
  {
  ...
  */
  ...
  {
    fCoordinates.SetCoordinates(v[index0], v[index0 + 1], v[index0 + 2],
                                v[index0 + 3]);
    return *this;
  }
#endif
  ...
  */
  constexpr const CoordSystem &Coordinates() const { return fCoordinates; }

  /**
     Set internal data based on an array of 4 Scalar numbers
  */
  constexpr LorentzVector<CoordSystem> &SetCoordinates(const Scalar src[])
  {
  ...
  */
  constexpr LorentzVector<CoordSystem> &SetCoordinates(Scalar a, Scalar b,
                                                       Scalar c, Scalar d)
  {
  ...
  */
  ...
  template <class IT>
#ifndef NDEBUG
  constexpr LorentzVector<CoordSystem> &SetCoordinates(IT begin, IT end)
  {
#else
  LorentzVector<CoordSystem> &SetCoordinates(IT begin, IT /* end */)
  {
  ...
  */
  constexpr void GetCoordinates(Scalar &a, Scalar &b, Scalar &c,
                                Scalar &d) const
  {
  ...
  */
  template <class IT>
#ifndef NDEBUG
  constexpr void GetCoordinates(IT begin, IT end) const
#else
  ...
  */
  template <class IT> constexpr void GetCoordinates(IT begin) const
  {
    Scalar a, b, c, d = 0;
    GetCoordinates(a, b, c, d);
    *begin++ = a;
  ...
  */
  constexpr LorentzVector<CoordSystem> &SetXYZT(Scalar xx, Scalar yy, Scalar zz,
                                                Scalar tt)
  {
    fCoordinates.SetPxPyPzE(xx, yy, zz, tt);
    return *this;
  }
  constexpr LorentzVector<CoordSystem> &SetPxPyPzE(Scalar xx, Scalar yy,
                                                   Scalar zz, Scalar ee)
  {
  ...
  /**
     Exact equality
  */
  constexpr bool operator==(const LorentzVector &rhs) const
  {
  ...
  /**
     spatial X component
  */
  constexpr Scalar Px() const { return fCoordinates.Px(); }
  constexpr Scalar X() const { return fCoordinates.Px(); }
  /**
     spatial Y component
  */
  constexpr Scalar Py() const { return fCoordinates.Py(); }
  constexpr Scalar Y() const { return fCoordinates.Py(); }
  /**
     spatial Z component
  */
  constexpr Scalar Pz() const { return fCoordinates.Pz(); }
  constexpr Scalar Z() const { return fCoordinates.Pz(); }
  /**
     return 4-th component (time, or energy for a 4-momentum vector)
  */
  constexpr Scalar E() const { return fCoordinates.E(); }
  constexpr Scalar T() const { return fCoordinates.E(); }
  /**
     return magnitude (mass) squared  M2 = T**2 - X**2 - Y**2 - Z**2
     (we use -,-,-,+ metric)
  */
  constexpr Scalar M2() const { return fCoordinates.M2(); }
  /**
     return magnitude (mass) using the  (-,-,-,+)  metric.
     If M2 is negative (space-like vector) a GenVector_exception
     is suggested and if continuing, - sqrt( -M2) is returned
  */
  constexpr Scalar M() const { return fCoordinates.M(); }
  /**
     return the spatial (3D) magnitude ( sqrt(X**2 + Y**2 + Z**2) )
  */
  constexpr Scalar R() const { return fCoordinates.R(); }
  constexpr Scalar P() const { return fCoordinates.R(); }
  /**
     return the square of the spatial (3D) magnitude ( X**2 + Y**2 + Z**2 )
  */
  constexpr Scalar P2() const { return P() * P(); }
  /**
     return the square of the transverse spatial component ( X**2 + Y**2 )
  */
  constexpr Scalar Perp2() const { return fCoordinates.Perp2(); }

  /**
     return the  transverse spatial component sqrt ( X**2 + Y**2 )
  */
  constexpr Scalar Pt() const { return fCoordinates.Pt(); }
  constexpr Scalar Rho() const { return fCoordinates.Pt(); }

  /**
     return the transverse mass squared
     \f[ m_t^2 = E^2 - p{_z}^2 \f]
  */
  constexpr Scalar Mt2() const { return fCoordinates.Mt2(); }

  /**
     return the transverse mass
     \f[ \sqrt{ m_t^2 = E^2 - p{_z}^2} X sign(E^ - p{_z}^2) \f]
  */
  constexpr Scalar Mt() const { return fCoordinates.Mt(); }

  /**
     return the transverse energy squared
     \f[ e_t = \frac{E^2 p_{\perp}^2 }{ |p|^2 } \f]
  */
  constexpr Scalar Et2() const { return fCoordinates.Et2(); }

  /**
     return the transverse energy
     \f[ e_t = \sqrt{ \frac{E^2 p_{\perp}^2 }{ |p|^2 } } X sign(E) \f]
  */
  constexpr Scalar Et() const { return fCoordinates.Et(); }

  /**
     azimuthal  Angle
  */
  constexpr Scalar Phi() const { return fCoordinates.Phi(); }

  /**
     polar Angle
  */
  constexpr Scalar Theta() const { return fCoordinates.Theta(); }

  /**
     pseudorapidity
     \f[ \eta = - \ln { \tan { \frac { \theta} {2} } } \f]
  */
  constexpr Scalar Eta() const { return fCoordinates.Eta(); }

  /**
     get the spatial components of the Vector in a
     DisplacementVector based on Cartesian Coordinates
  */
  constexpr ::ROOT::Math::DisplacementVector3D<Cartesian3D<Scalar>> Vect() const
  {
    return ::ROOT::Math::DisplacementVector3D<Cartesian3D<Scalar>>(X(), Y(),
                                                                   Z());
  }
  ...
  */
  ...
  constexpr Scalar Dot(const OtherLorentzVector &q) const
  {
  ...
  */
  template <class OtherLorentzVector>
  inline constexpr LorentzVector &operator+=(const OtherLorentzVector &q)
  {
  ...
  */
  template <class OtherLorentzVector>
  constexpr LorentzVector &operator-=(const OtherLorentzVector &q)
  {
    SetXYZT(x() - q.x(), y() - q.y(), z() - q.z(), t() - q.t());
    return *this;
  }
  ...
  */
  template <class OtherLorentzVector>
  constexpr LorentzVector operator+(const OtherLorentzVector &v2) const
  {
  ...
  */
  constexpr LorentzVector &operator*=(Scalar a)
  {
  ...
  */
  constexpr LorentzVector operator*(const Scalar &a) const
  {
  ...
  /**
     ...
     \return a new mathcoreLorentzVector q = v / a same type as v
  */
  constexpr LorentzVector<CoordSystem> operator/(const Scalar &a) const
  {
  ...
  */
  constexpr LorentzVector operator-() const
  {
  ...
  */
  constexpr Scalar Rapidity() const
  {
  ...
  */
  constexpr Scalar ColinearRapidity() const
  {
  ...
  */
  constexpr bool isTimelike() const
  {
    Scalar ee = E();
    Scalar pp = P();
    return ee * ee > pp * pp;
  ...
  */
  constexpr bool isLightlike(
      Scalar tolerance = 100 * std::numeric_limits<Scalar>::epsilon()) const
  {
    Scalar ee    = E();
    Scalar pp    = P();
    Scalar delta = ee - pp;
  ...
  */
  constexpr bool isSpacelike() const
  {
    Scalar ee = E();
    Scalar pp = P();
    return ee * ee < pp * pp;
  ...
  */
  constexpr BetaVector BoostToCM() const
  {
    if (E() == 0)
    {
      if (P() == 0)
  ...
  */
  ...
  constexpr BetaVector BoostToCM(const Other4Vector &v) const
  {
    Scalar eSum                                      = E() + v.E();
  ...
  */
  constexpr Scalar Beta() const
  {
    if (E() == 0)
    {
      ...
      {
        GenVector::Throw("LorentzVector::Beta() - beta computed for "
                         "LorentzVector with t = 0. Return an Infinite result");
        return 1. / E();
      }
    }
    if (M2() <= 0)
    {
      GenVector::Throw("LorentzVector::Beta() - beta computed for non-timelike "
                       "LorentzVector . Result is physically meaningless");
    }
    return P() / E();
  }
  /**
  ...
  */
  constexpr Scalar Gamma() const
  {
    ...
    if (E() == 0)
    {
      ...
      {
        GenVector::Throw("LorentzVector::Gamma() - gamma computed for "
                         "LorentzVector with t = 0. Return a zero result");
      }
    }
    if (t2 < v2)
    {
      GenVector::Throw("LorentzVector::Gamma() - gamma computed for a "
                       "spacelike LorentzVector. Imaginary result");
      return 0;
    }
    else if (t2 == v2)
    {
      GenVector::Throw("LorentzVector::Gamma() - gamma computed for a "
                       "lightlike LorentzVector. Infinite result");
    }
  ...
  constexpr Scalar theta() const { return fCoordinates.Theta(); }
  constexpr Scalar phi() const { return fCoordinates.Phi(); }
  constexpr Scalar rho() const { return fCoordinates.Rho(); }
  constexpr Scalar eta() const { return fCoordinates.Eta(); }
  constexpr Scalar pt() const { return fCoordinates.Pt(); }
  constexpr Scalar perp2() const { return fCoordinates.Perp2(); }
  constexpr Scalar mag2() const { return fCoordinates.M2(); }
  constexpr Scalar mag() const { return fCoordinates.M(); }
  constexpr Scalar mt() const { return fCoordinates.Mt(); }
  constexpr Scalar mt2() const { return fCoordinates.Mt2(); }

  // Methods  requested by CMS ---
  constexpr Scalar energy() const { return fCoordinates.E(); }
  constexpr Scalar mass() const { return fCoordinates.M(); }
  constexpr Scalar mass2() const { return fCoordinates.M2(); }

  /**
     Methods setting a Single-component
     Work only if the component is one of which the vector is represented.
     For example SetE will work for a PxPyPzE Vector but not for a PxPyPzM
     Vector.
  */
  constexpr LorentzVector<CoordSystem> &SetE(Scalar a)
  {
    fCoordinates.SetE(a);
    return *this;
  }
  constexpr LorentzVector<CoordSystem> &SetEta(Scalar a)
  {
    fCoordinates.SetEta(a);
    return *this;
  }
  constexpr LorentzVector<CoordSystem> &SetM(Scalar a)
  {
    fCoordinates.SetM(a);
    return *this;
  }
  constexpr LorentzVector<CoordSystem> &SetPhi(Scalar a)
  {
    fCoordinates.SetPhi(a);
    return *this;
  }
  constexpr LorentzVector<CoordSystem> &SetPt(Scalar a)
  {
    fCoordinates.SetPt(a);
    return *this;
  }
  constexpr LorentzVector<CoordSystem> &SetPx(Scalar a)
  {
    fCoordinates.SetPx(a);
    return *this;
  }
  constexpr LorentzVector<CoordSystem> &SetPy(Scalar a)
  {
    fCoordinates.SetPy(a);
    return *this;
  }
  constexpr LorentzVector<CoordSystem> &SetPz(Scalar a)
  {
...
inline constexpr LorentzVector<CoordSystem>
operator*(const typename LorentzVector<CoordSystem>::Scalar &a,
