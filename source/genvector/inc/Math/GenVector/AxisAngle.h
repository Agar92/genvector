...
/**
   AxisAngle class describing rotation represented with direction axis (3D
   Vector) and an angle of rotation around that axis.
...
public:
  ...
  */
  template <class IT> AxisAngle(IT begin, IT end) { SetComponents(begin, end); }
  ...
  */
  template <class OtherRotation> explicit AxisAngle(const OtherRotation &r);
  /**
     Assign from another supported rotation type (see gv_detail::convert )
  */
  template <class OtherRotation> AxisAngle &operator=(OtherRotation const &r);
  ...
  */
  template <class R> AxisAngle &operator*=(const R &r)
  {
    return *this = (*this) * r;
  }
...
/**
   Distance between two rotations
*/
template <class R> AxisAngle::Scalar AxisAngle::Distance(const R &r) const
{
...
inline AxisAngle::AxisAngle(const OtherRotation &r)
{
...
*/
template <class OtherRotation>
AxisAngle &AxisAngle::operator=(OtherRotation const &r)
{
  gv_detail::convert(r, *this);
  return *this;
}
